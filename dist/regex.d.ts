...
export declare const rxNumeric: (minLength?: number, maxLength?: number) => string;
export declare const rxUsername: (length?: number, useDash?: boolean, useDot?: boolean, startWithChar?: boolean, endWithChar?: boolean) => string;
